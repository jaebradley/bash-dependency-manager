...
main() {
  ...
  assert 0 "d41d8cd98f00b204e9800998ecf8427e" calculate_directory_file_contents_md5_hash "${temp_directory}" 
  local -r temp_file_path="${temp_directory}/foo"
  touch "${temp_file_path}" || fail "Could not create temp file: ${temp_file_path}"

  assert 0 "227bc609651f929e367c3b2b79e09d5b" calculate_directory_file_contents_md5_hash "${temp_directory}"
  ...
  assert 0 "3491c4dc96e647eea68b42ee1aa5a5d3" calculate_directory_file_contents_md5_hash "${temp_directory}"
